...
export ZSH=/Users/davidpvilaca/.oh-my-zsh

export CONVENTIONAL_GITHUB_RELEASER_TOKEN=5e739856394b676b0f558bdba8e02dcd41345ead
...
plugins=(git rails rails3 ruby heroku command-not-found brew docker git-flow-avh git-flow node npm python pip redis-cli sbt scala docker-compose jspm ng sudo bower redis-cli zsh-autosuggestions eslint github zsh-syntax-highlighting)
...
alias gru="git checkout master && git remote update && git pull origin master && git checkout develop && git pull origin develop"
